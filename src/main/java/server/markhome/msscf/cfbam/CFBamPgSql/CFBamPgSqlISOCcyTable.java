// Description: Java 11 PostgreSQL Jdbc DbIO implementation for ISOCcy.
...
/*
 *	CFBamPgSqlISOCcyTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCcy.
 */
public class CFBamPgSqlISOCcyTable
	implements ICFBamISOCcyTable
{
	...
	public CFBamPgSqlISOCcyTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecISOCcyBuff Buff )
	{
		...
		try {
			...
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_iso_ccy( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
	...
	public String S_sqlSelectISOCcyDistinctClassCode = null;
	...
	public String S_sqlSelectISOCcyBuff = null;
	...
	public CFSecISOCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOCcyId )
	{
		final String S_ProcName = "CFBamPgSqlISOCcyTable.readDerivedByIdIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCcyBuff readDerivedByCcyCdIdx( CFSecAuthorization Authorization,
		String ISOCode )
	{
		final String S_ProcName = "CFBamPgSqlISOCcyTable.readDerivedByCcyCdIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCcyBuff readDerivedByCcyNmIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFBamPgSqlISOCcyTable.readDerivedByCcyNmIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFSecISOCcyPKey PKey )
	{
		...
		try {
			...
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_ccy( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		CFSecISOCcyPKey PKey )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			short ISOCcyId = PKey.getRequiredISOCcyId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_iso_ccy( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
	...
	public CFSecISOCcyBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_ccy_all( ?, ?, ?, ?, ? )";
		...
		short ISOCcyId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_ccy_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		String ISOCode )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_ccy_by_ccycdidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		String Name )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_ccy_by_ccynmidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		CFSecISOCcyBuff Buff )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_iso_ccy( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
		...
		CFSecISOCcyBuff Buff )
	{
		...
		try {
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_ccy( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		short argISOCcyId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_ccy_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
