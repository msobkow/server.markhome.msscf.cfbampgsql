// Description: Java 11 PostgreSQL Jdbc DbIO implementation for TZDateType.
	...
	implements ICFBamTZDateTypeTable
{
	...
	public String getSqlSelectTZDateTypeDistinctClassCode() {
		if( S_sqlSelectTZDateTypeDistinctClassCode == null ) {
			S_sqlSelectTZDateTypeDistinctClassCode =
					...
					+		"AND a83a.Id = a809.Id "
						+	"INNER JOIN " + schema.getLowerDbSchemaName() + ".dztyp a83b ON "
					+		"a83b.TenantId = a809.TenantId "
					+		"AND a83b.Id = a809.Id ";
		}
	...
	public CFBamTZDateTypeBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
	...
	public CFBamTZDateTypeBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
	...
	public void deleteTZDateTypeByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
