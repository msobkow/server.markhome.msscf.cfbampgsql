// Description: Java 11 PostgreSQL Jdbc DbIO implementation for TimeDef.
...
/*
 *	CFBamPgSqlTimeDefTable PostgreSQL Jdbc DbIO implementation
 *	for TimeDef.
 */
public class CFBamPgSqlTimeDefTable
	implements ICFBamTimeDefTable
{
	...
	public CFBamPgSqlTimeDefTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}

	public void createTimeDef( CFSecAuthorization Authorization,
		CFBamTimeDefBuff Buff )
	{
		...
		try {
			...
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_tmdef( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
			...
			if( resultSet.next() ) {
				CFBamTimeDefBuff createdBuff = unpackTimeDefResultSetToBuff( resultSet );
				if( resultSet.next() ) {
	...
	public String S_sqlSelectTimeDefDistinctClassCode = null;

	public String getSqlSelectTimeDefDistinctClassCode() {
		if( S_sqlSelectTimeDefDistinctClassCode == null ) {
			S_sqlSelectTimeDefDistinctClassCode =
					"SELECT "
		...
		return( S_sqlSelectTimeDefDistinctClassCode );
	}

	public String S_sqlSelectTimeDefBuff = null;

	public String getSqlSelectTimeDefBuff() {
		if( S_sqlSelectTimeDefBuff == null ) {
			S_sqlSelectTimeDefBuff =
					"SELECT "
					+		"a809.ClassCode, "
					+		"a809.TenantId, "
					+		"a809.Id, "
		...
		return( S_sqlSelectTimeDefBuff );
	}

	protected CFBamTimeDefBuff unpackTimeDefResultSetToBuff( ResultSet resultSet )
	throws SQLException
	{
		final String S_ProcName = "unpackTimeDefResultSetToBuff";
		int idxcol = 1;
		String classCode = resultSet.getString( idxcol );
		idxcol++;
		CFBamTimeDefBuff buff;
		if( classCode.equals( "a843" ) ) {
	...
	public CFBamTimeDefBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_cc_tmdef( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamTimeDefBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "readAllDerived";
		CFBamTimeDefBuff[] buffArray;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
				"Transaction not open" );
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_all( ?, ?, ?, ?, ? )";
		...
		List<CFBamTimeDefBuff> resultList = new LinkedList<CFBamTimeDefBuff>();
		...
		int idx = 0;
		buffArray = new CFBamTimeDefBuff[ resultList.size() ];
		Iterator<CFBamTimeDefBuff> iter = resultList.iterator();
		while( iter.hasNext() ) {
	...
	public CFBamTimeDefBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamPgSqlTimeDefTable.readDerivedByIdIdx() ";
		CFBamTimeDefBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamPgSqlTimeDefTable.readDerivedByUNameIdx() ";
		CFBamTimeDefBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_by_valtentidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		int idx = 0;
		CFBamTimeDefBuff[] retBuff = new CFBamTimeDefBuff[ resultList.size() ];
		Iterator<CFBamTimeDefBuff> iter = resultList.iterator();
		while( iter.hasNext() ) {
	...
	public CFBamTimeDefBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_by_scopeidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long DefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_by_previdx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_by_nextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_by_contprevidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_cc_by_contnextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		...
		try {
			...
			long TenantId = PKey.getRequiredTenantId();
			long Id = PKey.getRequiredId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
			...
			if( resultSet.next() ) {
				CFBamTimeDefBuff buff = unpackTimeDefResultSetToBuff( resultSet );
				if( resultSet.next() ) {
					throw new CFLibRuntimeException( getClass(),
						S_ProcName,
						"Did not expect multi-record response" );
	...
	public CFBamTimeDefBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		...
		try {
			...
			long TenantId = PKey.getRequiredTenantId();
			long Id = PKey.getRequiredId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_tmdef( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_all( ?, ?, ?, ?, ? )";
			...
			List<CFBamTimeDefBuff> buffList = new LinkedList<CFBamTimeDefBuff>();
			while( resultSet.next() ) {
				CFBamTimeDefBuff buff = unpackTimeDefResultSetToBuff( resultSet );
				buffList.add( buff );
			}
			int idx = 0;
			CFBamTimeDefBuff[] retBuff = new CFBamTimeDefBuff[ buffList.size() ];
			Iterator<CFBamTimeDefBuff> iter = buffList.iterator();
			while( iter.hasNext() ) {
				retBuff[idx++] = iter.next();
			}
			return( retBuff );
	...
	public CFBamTimeDefBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_by_valtentidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_by_scopeidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_by_previdx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_by_nextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_by_contprevidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamTimeDefBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tmdef_by_contnextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public void updateTimeDef( CFSecAuthorization Authorization,
		CFBamTimeDefBuff Buff )
	{
		final String S_ProcName = "updateTimeDef";
		ResultSet resultSet = null;
		try {
			String ClassCode = Buff.getClassCode();
			long TenantId = Buff.getRequiredTenantId();
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_tmdef( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
			...
			if( resultSet.next() ) {
				CFBamTimeDefBuff updatedBuff = unpackTimeDefResultSetToBuff( resultSet );
				if( resultSet.next() ) {
					throw new CFLibRuntimeException( getClass(),
						S_ProcName,
						"Did not expect multi-record response" );
	...
	public void deleteTimeDef( CFSecAuthorization Authorization,
		CFBamTimeDefBuff Buff )
	{
		final String S_ProcName = "deleteTimeDef";
		ResultSet resultSet = null;
		try {
			Connection cnx = schema.getCnx();
			long TenantId = Buff.getRequiredTenantId();
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	public void deleteTimeDefByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteTimeDefByIdIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredId() );
	}

	public void deleteTimeDefByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteTimeDefByUNameIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredScopeId(),
			argKey.getRequiredName() );
	}

	public void deleteTimeDefByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		final String S_ProcName = "deleteTimeDefByValTentIdx";
		ResultSet resultSet = null;
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef_by_valtentidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteTimeDefByValTentIdx( Authorization,
			argKey.getRequiredTenantId() );
	}

	public void deleteTimeDefByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef_by_scopeidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteTimeDefByScopeIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredScopeId() );
	}

	public void deleteTimeDefByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteTimeDefByDefSchemaIdx( Authorization,
			argKey.getOptionalDefSchemaTenantId(),
			argKey.getOptionalDefSchemaId() );
	}

	public void deleteTimeDefByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef_by_previdx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteTimeDefByPrevIdx( Authorization,
			argKey.getOptionalPrevTenantId(),
			argKey.getOptionalPrevId() );
	}

	public void deleteTimeDefByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef_by_nextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteTimeDefByNextIdx( Authorization,
			argKey.getOptionalNextTenantId(),
			argKey.getOptionalNextId() );
	}

	public void deleteTimeDefByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef_by_contprevidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteTimeDefByContPrevIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredScopeId(),
			argKey.getOptionalPrevId() );
	}

	public void deleteTimeDefByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tmdef_by_contnextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteTimeDefByContNextIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredScopeId(),
			argKey.getOptionalNextId() );
	}
	 ...
	 */
	public CFBamTimeDefBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int argRevision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_moveup_tmdef( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", ? )";
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamTimeDefBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int argRevision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_movedown_tmdef( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", ? )";
	...
	public void releasePreparedStatements() {
		...
		S_sqlSelectTimeDefDistinctClassCode = null;
		S_sqlSelectTimeDefBuff = null;
