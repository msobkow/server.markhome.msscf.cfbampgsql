// Description: Java 11 PostgreSQL Jdbc DbIO implementation for SecGrpMemb.
...
/*
 *	CFBamPgSqlSecGrpMembTable PostgreSQL Jdbc DbIO implementation
 *	for SecGrpMemb.
 */
public class CFBamPgSqlSecGrpMembTable
	implements ICFBamSecGrpMembTable
{
	...
	public CFBamPgSqlSecGrpMembTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecSecGrpMembBuff Buff )
	{
		...
		try {
			...
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_secmemb( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
	...
	public String S_sqlSelectSecGrpMembDistinctClassCode = null;
	...
	public String S_sqlSelectSecGrpMembBuff = null;
	...
	public CFSecSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpMembId )
	{
		final String S_ProcName = "CFBamPgSqlSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFBamPgSqlSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFSecSecGrpMembPKey PKey )
	{
		...
		try {
			...
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_secmemb( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		CFSecSecGrpMembPKey PKey )
	{
		...
		try {
			...
			long ClusterId = PKey.getRequiredClusterId();
			long SecGrpMembId = PKey.getRequiredSecGrpMembId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_secmemb( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFSecSecGrpMembBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_secmemb_all( ?, ?, ?, ?, ? )";
		...
		Long priorSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_page_secmemb_all( ?, ?, ?, ?, ?, ?, ? )";
			...
			if( priorSecGrpMembId != null ) {
				stmtPageBuffAll.setLong( argIdx++, priorSecGrpMembId.longValue() );
			}
			else {
				stmtPageBuffAll.setNull( argIdx++, java.sql.Types.BIGINT );
			}
		...
		long SecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_secmemb_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		long ClusterId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_secmemb_by_clusteridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		int SecGroupId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_secmemb_by_groupidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		UUID SecUserId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_secmemb_by_useridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		UUID SecUserId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_secmemb_by_uuseridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		Long priorSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_page_secmemb_by_clusteridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		Long priorSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_page_secmemb_by_groupidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		Long priorSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_page_secmemb_by_useridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		CFSecSecGrpMembBuff Buff )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_secmemb( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
		...
		CFSecSecGrpMembBuff Buff )
	{
		...
		try {
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_secmemb( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		long argSecGrpMembId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_secmemb_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		long argClusterId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_secmemb_by_clusteridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		int argSecGroupId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_secmemb_by_groupidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		UUID argSecUserId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_secmemb_by_useridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		UUID argSecUserId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_secmemb_by_uuseridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
