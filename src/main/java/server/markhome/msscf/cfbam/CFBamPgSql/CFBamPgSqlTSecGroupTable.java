// Description: Java 11 PostgreSQL Jdbc DbIO implementation for TSecGroup.
...
/*
 *	CFBamPgSqlTSecGroupTable PostgreSQL Jdbc DbIO implementation
 *	for TSecGroup.
 */
public class CFBamPgSqlTSecGroupTable
	implements ICFBamTSecGroupTable
{
	...
	public CFBamPgSqlTSecGroupTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecTSecGroupBuff Buff )
	{
		...
		try {
			...
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_tsecgrp( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
	...
	public String S_sqlSelectTSecGroupDistinctClassCode = null;
	...
	public String S_sqlSelectTSecGroupBuff = null;
	...
	public CFSecTSecGroupBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int TSecGroupId )
	{
		final String S_ProcName = "CFBamPgSqlTSecGroupTable.readDerivedByIdIdx() ";
		CFSecTSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGroupBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFBamPgSqlTSecGroupTable.readDerivedByUNameIdx() ";
		CFSecTSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFSecTSecGroupPKey PKey )
	{
		...
		try {
			...
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecgrp( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		CFSecTSecGroupPKey PKey )
	{
		...
		try {
			...
			long TenantId = PKey.getRequiredTenantId();
			int TSecGroupId = PKey.getRequiredTSecGroupId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_tsecgrp( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFSecTSecGroupBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecgrp_all( ?, ?, ?, ?, ? )";
		...
		int TSecGroupId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecgrp_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		long TenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecgrp_by_tenantidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		boolean IsVisible )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecgrp_by_tenantvisidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
			...
			stmtReadBuffByTenantVisIdx.setBoolean( argIdx++, IsVisible );
		...
		String Name )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecgrp_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		CFSecTSecGroupBuff Buff )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_tsecgrp( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
		...
		CFSecTSecGroupBuff Buff )
	{
		...
		try {
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecgrp( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		int argTSecGroupId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecgrp_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		long argTenantId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecgrp_by_tenantidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		boolean argIsVisible )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecgrp_by_tenantvisidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
				...
				stmtDeleteByTenantVisIdx.setBoolean( argIdx++, argIsVisible );
				resultSet = stmtDeleteByTenantVisIdx.executeQuery();
				if( resultSet.next() ) {
					boolean deleteFlag = resultSet.getBoolean( 1 );
					if( resultSet.next() ) {
						throw new CFLibRuntimeException( getClass(),
		...
		String argName )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecgrp_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
