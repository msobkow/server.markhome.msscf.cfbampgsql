// Description: Java 11 PostgreSQL Jdbc DbIO implementation for IndexCol.
	...
	implements ICFBamIndexColTable
{
		...
		CFBamIndexColBuff Buff )
	{
		...
		try {
			...
			stmtCreateByPKey.setString( argIdx++, "a822" );
	...
	public String getSqlSelectIndexColDistinctClassCode() {
		if( S_sqlSelectIndexColDistinctClassCode == null ) {
			S_sqlSelectIndexColDistinctClassCode =
					"SELECT "
					+		"DISTINCT a822.ClassCode "
					+	"FROM " + schema.getLowerDbSchemaName() + ".idxcol AS a822 ";
		}
		...
		CFBamIndexColBuff Buff )
	{
		...
		try {
			...
			stmtUpdateByPKey.setString( argIdx++, "a822" );
