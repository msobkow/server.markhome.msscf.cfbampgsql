// Description: Java 11 PostgreSQL Jdbc DbIO implementation for TSecGrpMemb.
...
/*
 *	CFBamPgSqlTSecGrpMembTable PostgreSQL Jdbc DbIO implementation
 *	for TSecGrpMemb.
 */
public class CFBamPgSqlTSecGrpMembTable
	implements ICFBamTSecGrpMembTable
{
	...
	public CFBamPgSqlTSecGrpMembTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecTSecGrpMembBuff Buff )
	{
		...
		try {
			...
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_tsecmemb( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
	...
	public String S_sqlSelectTSecGrpMembDistinctClassCode = null;
	...
	public String S_sqlSelectTSecGrpMembBuff = null;
	...
	public CFSecTSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpMembId )
	{
		final String S_ProcName = "CFBamPgSqlTSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFBamPgSqlTSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFSecTSecGrpMembPKey PKey )
	{
		...
		try {
			...
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecmemb( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		CFSecTSecGrpMembPKey PKey )
	{
		...
		try {
			...
			long TenantId = PKey.getRequiredTenantId();
			long TSecGrpMembId = PKey.getRequiredTSecGrpMembId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_tsecmemb( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFSecTSecGrpMembBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecmemb_all( ?, ?, ?, ?, ? )";
		...
		Long priorTSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_page_tsecmemb_all( ?, ?, ?, ?, ?, ?, ? )";
			...
			if( priorTSecGrpMembId != null ) {
				stmtPageBuffAll.setLong( argIdx++, priorTSecGrpMembId.longValue() );
			}
			else {
				stmtPageBuffAll.setNull( argIdx++, java.sql.Types.BIGINT );
			}
		...
		long TSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecmemb_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		long TenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecmemb_by_tenantidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		int TSecGroupId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecmemb_by_groupidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		UUID SecUserId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecmemb_by_useridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		UUID SecUserId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_tsecmemb_by_uuseridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		Long priorTSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_page_tsecmemb_by_tenantidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		Long priorTSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_page_tsecmemb_by_groupidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		Long priorTSecGrpMembId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_page_tsecmemb_by_useridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		CFSecTSecGrpMembBuff Buff )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_tsecmemb( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
		...
		CFSecTSecGrpMembBuff Buff )
	{
		...
		try {
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecmemb( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		long argTSecGrpMembId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecmemb_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		long argTenantId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecmemb_by_tenantidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		int argTSecGroupId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecmemb_by_groupidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		UUID argSecUserId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecmemb_by_useridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		UUID argSecUserId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_tsecmemb_by_uuseridx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
