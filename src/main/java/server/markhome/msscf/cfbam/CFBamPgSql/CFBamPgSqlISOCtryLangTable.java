// Description: Java 11 PostgreSQL Jdbc DbIO implementation for ISOCtryLang.
...
/*
 *	CFBamPgSqlISOCtryLangTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCtryLang.
 */
public class CFBamPgSqlISOCtryLangTable
	implements ICFBamISOCtryLangTable
{
	...
	public CFBamPgSqlISOCtryLangTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecISOCtryLangBuff Buff )
	{
		...
		try {
			...
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_iso_cntrylng( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
	...
	public String S_sqlSelectISOCtryLangDistinctClassCode = null;
	...
	public String S_sqlSelectISOCtryLangBuff = null;
	...
	public CFSecISOCtryLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOLangId )
	{
		final String S_ProcName = "CFBamPgSqlISOCtryLangTable.readDerivedByIdIdx() ";
		CFSecISOCtryLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFSecISOCtryLangPKey PKey )
	{
		...
		try {
			...
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_cntrylng( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		CFSecISOCtryLangPKey PKey )
	{
		...
		try {
			...
			short ISOCtryId = PKey.getRequiredISOCtryId();
			short ISOLangId = PKey.getRequiredISOLangId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_iso_cntrylng( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFSecISOCtryLangBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_cntrylng_all( ?, ?, ?, ?, ? )";
		...
		short ISOLangId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_cntrylng_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		short ISOCtryId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_cntrylng_by_ctryidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		short ISOLangId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_cntrylng_by_langidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		CFSecISOCtryLangBuff Buff )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_iso_cntrylng( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + " )";
		...
		CFSecISOCtryLangBuff Buff )
	{
		...
		try {
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_cntrylng( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		short argISOLangId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_cntrylng_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		short argISOCtryId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_cntrylng_by_ctryidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		short argISOLangId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_cntrylng_by_langidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
