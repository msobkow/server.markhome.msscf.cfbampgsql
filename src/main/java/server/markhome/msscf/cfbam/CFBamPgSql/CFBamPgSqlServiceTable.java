...
/*
 *	CFBamPgSqlServiceTable PostgreSQL Jdbc DbIO implementation
 *	for Service.
 */
public class CFBamPgSqlServiceTable
	implements ICFBamServiceTable
{
	...
	public CFBamPgSqlServiceTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long ServiceId )
	{
		final String S_ProcName = "CFBamPgSqlServiceTable.readDerivedByIdIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUTypeIdx( CFSecAuthorization Authorization,
		...
		int ServiceTypeId )
	{
		final String S_ProcName = "CFBamPgSqlServiceTable.readDerivedByUTypeIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUHostPortIdx( CFSecAuthorization Authorization,
		...
		short HostPort )
	{
		final String S_ProcName = "CFBamPgSqlServiceTable.readDerivedByUHostPortIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
