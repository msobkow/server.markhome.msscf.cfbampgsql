// Description: Java 11 PostgreSQL Jdbc DbIO implementation for ClearSubDep2.
...
/*
 *	CFBamPgSqlClearSubDep2Table PostgreSQL Jdbc DbIO implementation
 *	for ClearSubDep2.
 */
public class CFBamPgSqlClearSubDep2Table
	implements ICFBamClearSubDep2Table
{
	...
	protected PreparedStatement stmtReadBuffByClearSubDep1Idx = null;
	protected PreparedStatement stmtReadBuffByUNameIdx = null;
	protected PreparedStatement stmtDeleteByIdIdx = null;
	protected PreparedStatement stmtDeleteByTenantIdx = null;
	protected PreparedStatement stmtDeleteByClearDepIdx = null;
	protected PreparedStatement stmtDeleteByDefSchemaIdx = null;
	protected PreparedStatement stmtDeleteByClearSubDep1Idx = null;
	protected PreparedStatement stmtDeleteByUNameIdx = null;

	public CFBamPgSqlClearSubDep2Table( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamClearSubDep2Buff Buff )
	{
		...
		try {
			...
			long ClearSubDep1TenantId = Buff.getRequiredClearSubDep1TenantId();
			long ClearSubDep1Id = Buff.getRequiredClearSubDep1Id();
			String Name = Buff.getRequiredName();
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_clrsubdep2( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
			...
			stmtCreateByPKey.setLong( argIdx++, ClearSubDep1TenantId );
			stmtCreateByPKey.setLong( argIdx++, ClearSubDep1Id );
			...
			if( resultSet.next() ) {
				...
				Buff.setRequiredClearSubDep1TenantId( createdBuff.getRequiredClearSubDep1TenantId() );
				Buff.setRequiredClearSubDep1Id( createdBuff.getRequiredClearSubDep1Id() );
	...
	public String S_sqlSelectClearSubDep2DistinctClassCode = null;
	...
	public String getSqlSelectClearSubDep2DistinctClassCode() {
		if( S_sqlSelectClearSubDep2DistinctClassCode == null ) {
			S_sqlSelectClearSubDep2DistinctClassCode =
					...
					+		"AND a810.Id = a801.Id "
						+	"INNER JOIN " + schema.getLowerDbSchemaName() + ".clrsubdep2 a812 ON "
					+		"a812.TenantId = a801.TenantId "
					+		"AND a812.Id = a801.Id ";
		}
		return( S_sqlSelectClearSubDep2DistinctClassCode );
	}

	public String S_sqlSelectClearSubDep2Buff = null;
	...
	throws SQLException
	{
		...
		idxcol++;
		buff.setRequiredClearSubDep1TenantId( resultSet.getLong( idxcol ) );
		idxcol++;
		buff.setRequiredClearSubDep1Id( resultSet.getLong( idxcol ) );
		idxcol++;
	...
	public CFBamClearSubDep2Buff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFBamPgSqlClearSubDep2Table.readDerivedByIdIdx() ";
		CFBamClearSubDep2Buff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		long RelationId )
	{
		...
		CFBamClearSubDep2Buff[] buffList = readBuffByClearDepIdx( Authorization,
				TenantId,
				RelationId );
		return( buffList );
		...
		Long DefSchemaId )
	{
		...
		CFBamClearSubDep2Buff[] buffList = readBuffByDefSchemaIdx( Authorization,
				DefSchemaTenantId,
				DefSchemaId );
		return( buffList );
	...
	public CFBamClearSubDep2Buff[] readDerivedByClearSubDep1Idx( CFSecAuthorization Authorization,
		...
		long ClearSubDep1Id )
	{
		final String S_ProcName = "readDerivedByClearSubDep1Idx";
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
				"Transaction not open" );
		}
		CFBamClearSubDep2Buff[] buffList = readBuffByClearSubDep1Idx( Authorization,
	...
	public CFBamClearSubDep2Buff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFBamPgSqlClearSubDep2Table.readDerivedByUNameIdx() ";
		CFBamClearSubDep2Buff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFBamScopePKey PKey )
	{
		...
		try {
			...
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_clrsubdep2( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		CFBamScopePKey PKey )
	{
		...
		try {
			...
			long TenantId = PKey.getRequiredTenantId();
			long Id = PKey.getRequiredId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_clrsubdep2( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamClearSubDep2Buff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_clrsubdep2_all( ?, ?, ?, ?, ? )";
		...
		long Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_clrsubdep2_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		long TenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_clrsubdep2_by_tenantidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_clrsubdep2_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
		...
		Long DefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_clrsubdep2_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamClearSubDep2Buff[] readBuffByClearSubDep1Idx( CFSecAuthorization Authorization,
		...
		long ClearSubDep1Id )
	{
		final String S_ProcName = "readBuffByClearSubDep1Idx";
		ResultSet resultSet = null;
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_clrsubdep2_by_clearsubdep1idx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
			if( stmtReadBuffByClearSubDep1Idx == null ) {
				stmtReadBuffByClearSubDep1Idx = cnx.prepareStatement( sql );
			}
			int argIdx = 1;
			stmtReadBuffByClearSubDep1Idx.setLong( argIdx++, ( Authorization == null ) ? 0 : Authorization.getSecClusterId() );
			stmtReadBuffByClearSubDep1Idx.setString( argIdx++, ( Authorization == null ) ? "" : Authorization.getSecUserId().toString() );
			stmtReadBuffByClearSubDep1Idx.setString( argIdx++, ( Authorization == null ) ? "" : Authorization.getSecSessionId().toString() );
			stmtReadBuffByClearSubDep1Idx.setLong( argIdx++, ( Authorization == null ) ? 0 : Authorization.getSecClusterId() );
			stmtReadBuffByClearSubDep1Idx.setLong( argIdx++, ( Authorization == null ) ? 0 : Authorization.getSecTenantId() );
			stmtReadBuffByClearSubDep1Idx.setLong( argIdx++, ClearSubDep1TenantId );
			stmtReadBuffByClearSubDep1Idx.setLong( argIdx++, ClearSubDep1Id );
			resultSet = stmtReadBuffByClearSubDep1Idx.executeQuery();
			List<CFBamClearSubDep2Buff> buffList = new LinkedList<CFBamClearSubDep2Buff>();
			while( resultSet.next() ) {
				CFBamClearSubDep2Buff buff = unpackClearSubDep2ResultSetToBuff( resultSet );
				buffList.add( buff );
		...
		String Name )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_clrsubdep2_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
			...
			stmtReadBuffByUNameIdx.setLong( argIdx++, ClearSubDep1TenantId );
			stmtReadBuffByUNameIdx.setLong( argIdx++, ClearSubDep1Id );
		...
		CFBamClearSubDep2Buff Buff )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_clrsubdep2( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
			...
			stmtUpdateByPKey.setLong( argIdx++, ClearSubDep1TenantId );
			stmtUpdateByPKey.setLong( argIdx++, ClearSubDep1Id );
			...
			if( resultSet.next() ) {
				...
				Buff.setRequiredClearSubDep1TenantId( updatedBuff.getRequiredClearSubDep1TenantId() );
				Buff.setRequiredClearSubDep1Id( updatedBuff.getRequiredClearSubDep1Id() );
		...
		CFBamClearSubDep2Buff Buff )
	{
		...
		try {
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_clrsubdep2( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		long argId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_clrsubdep2_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		long argTenantId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_clrsubdep2_by_tenantidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	public void deleteClearSubDep2ByClearDepIdx( CFSecAuthorization Authorization,
		...
		long argRelationId )
	{
		final String S_ProcName = "deleteClearSubDep2ByClearDepIdx";
		ResultSet resultSet = null;
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_clrsubdep2_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteClearSubDep2ByClearDepIdx( Authorization,
			argKey.getRequiredTenantId(),
	...
	public void deleteClearSubDep2ByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		final String S_ProcName = "deleteClearSubDep2ByDefSchemaIdx";
		ResultSet resultSet = null;
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_clrsubdep2_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteClearSubDep2ByDefSchemaIdx( Authorization,
	...
	{
		final String S_ProcName = "deleteClearSubDep2ByClearSubDep1Idx";
		ResultSet resultSet = null;
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_clrsubdep2_by_clearsubdep1idx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
				if( stmtDeleteByClearSubDep1Idx == null ) {
					stmtDeleteByClearSubDep1Idx = cnx.prepareStatement( sql );
				}
				int argIdx = 1;
				stmtDeleteByClearSubDep1Idx.setLong( argIdx++, ( Authorization == null ) ? 0 : Authorization.getSecClusterId() );
				stmtDeleteByClearSubDep1Idx.setString( argIdx++, ( Authorization == null ) ? "" : Authorization.getSecUserId().toString() );
				stmtDeleteByClearSubDep1Idx.setString( argIdx++, ( Authorization == null ) ? "" : Authorization.getSecSessionId().toString() );
				stmtDeleteByClearSubDep1Idx.setLong( argIdx++, ( Authorization == null ) ? 0 : Authorization.getSecClusterId() );
				stmtDeleteByClearSubDep1Idx.setLong( argIdx++, ( Authorization == null ) ? 0 : Authorization.getSecTenantId() );
				stmtDeleteByClearSubDep1Idx.setLong( argIdx++, argClearSubDep1TenantId );
				stmtDeleteByClearSubDep1Idx.setLong( argIdx++, argClearSubDep1Id );
				resultSet = stmtDeleteByClearSubDep1Idx.executeQuery();
				if( resultSet.next() ) {
					boolean deleteFlag = resultSet.getBoolean( 1 );
					if( resultSet.next() ) {
						throw new CFLibRuntimeException( getClass(),
	...
	{
		deleteClearSubDep2ByClearSubDep1Idx( Authorization,
			argKey.getRequiredClearSubDep1TenantId(),
			argKey.getRequiredClearSubDep1Id() );
	}
		...
		String argName )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_clrsubdep2_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
				...
				stmtDeleteByUNameIdx.setLong( argIdx++, argClearSubDep1TenantId );
				stmtDeleteByUNameIdx.setLong( argIdx++, argClearSubDep1Id );
	...
	public void releasePreparedStatements() {
		...
		if( stmtDeleteByClearSubDep1Idx != null ) {
			try {
				stmtDeleteByClearSubDep1Idx.close();
			}
			catch( SQLException e ) {
			}
			stmtDeleteByClearSubDep1Idx = null;
		}
		if( stmtDeleteByUNameIdx != null ) {
			try {
		...
		if( stmtReadBuffByClearSubDep1Idx != null ) {
			try {
				stmtReadBuffByClearSubDep1Idx.close();
			}
			catch( SQLException e ) {
			}
			stmtReadBuffByClearSubDep1Idx = null;
		}
		if( stmtReadBuffByUNameIdx != null ) {
			try {
