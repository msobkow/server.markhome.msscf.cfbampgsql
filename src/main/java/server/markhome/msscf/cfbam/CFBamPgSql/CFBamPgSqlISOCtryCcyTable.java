...
/*
 *	CFBamPgSqlISOCtryCcyTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCtryCcy.
 */
public class CFBamPgSqlISOCtryCcyTable
	implements ICFBamISOCtryCcyTable
{
	...
	public CFBamPgSqlISOCtryCcyTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOCcyId )
	{
		final String S_ProcName = "CFBamPgSqlISOCtryCcyTable.readDerivedByIdIdx() ";
		CFSecISOCtryCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
