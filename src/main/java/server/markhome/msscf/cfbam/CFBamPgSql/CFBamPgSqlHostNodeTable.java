...
/*
 *	CFBamPgSqlHostNodeTable PostgreSQL Jdbc DbIO implementation
 *	for HostNode.
 */
public class CFBamPgSqlHostNodeTable
	implements ICFBamHostNodeTable
{
	...
	public CFBamPgSqlHostNodeTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecHostNodeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long HostNodeId )
	{
		final String S_ProcName = "CFBamPgSqlHostNodeTable.readDerivedByIdIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		...
		String Description )
	{
		final String S_ProcName = "CFBamPgSqlHostNodeTable.readDerivedByUDescrIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByHostNameIdx( CFSecAuthorization Authorization,
		...
		String HostName )
	{
		final String S_ProcName = "CFBamPgSqlHostNodeTable.readDerivedByHostNameIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
