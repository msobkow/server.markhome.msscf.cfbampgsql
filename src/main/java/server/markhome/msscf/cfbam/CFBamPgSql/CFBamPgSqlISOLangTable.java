// Description: Java 11 PostgreSQL Jdbc DbIO implementation for ISOLang.
...
/*
 *	CFBamPgSqlISOLangTable PostgreSQL Jdbc DbIO implementation
 *	for ISOLang.
 */
public class CFBamPgSqlISOLangTable
	implements ICFBamISOLangTable
{
	...
	public CFBamPgSqlISOLangTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecISOLangBuff Buff )
	{
		...
		try {
			...
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_iso_lang( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
	...
	public String S_sqlSelectISOLangDistinctClassCode = null;
	...
	public String S_sqlSelectISOLangBuff = null;
	...
	public CFSecISOLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOLangId )
	{
		final String S_ProcName = "CFBamPgSqlISOLangTable.readDerivedByIdIdx() ";
		CFSecISOLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOLangBuff readDerivedByCode3Idx( CFSecAuthorization Authorization,
		String ISO6392Code )
	{
		final String S_ProcName = "CFBamPgSqlISOLangTable.readDerivedByCode3Idx() ";
		CFSecISOLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFSecISOLangPKey PKey )
	{
		...
		try {
			...
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_lang( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		CFSecISOLangPKey PKey )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			short ISOLangId = PKey.getRequiredISOLangId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_iso_lang( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
	...
	public CFSecISOLangBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_lang_all( ?, ?, ?, ?, ? )";
		...
		short ISOLangId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_lang_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		String ISO6392Code )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_lang_by_code3idx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		String ISO6391Code )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_iso_lang_by_code2idx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		CFSecISOLangBuff Buff )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_iso_lang( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
		...
		CFSecISOLangBuff Buff )
	{
		...
		try {
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_lang( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		short argISOLangId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_lang_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		String argISO6392Code )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_lang_by_code3idx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
				...
				resultSet = stmtDeleteByCode3Idx.executeQuery();
				if( resultSet.next() ) {
					boolean deleteFlag = resultSet.getBoolean( 1 );
					if( resultSet.next() ) {
						throw new CFLibRuntimeException( getClass(),
		...
		String argISO6391Code )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_iso_lang_by_code2idx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
