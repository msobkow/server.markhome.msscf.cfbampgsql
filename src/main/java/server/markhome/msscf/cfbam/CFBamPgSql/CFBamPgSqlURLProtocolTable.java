// Description: Java 11 PostgreSQL Jdbc DbIO implementation for URLProtocol.
...
/*
 *	CFBamPgSqlURLProtocolTable PostgreSQL Jdbc DbIO implementation
 *	for URLProtocol.
 */
public class CFBamPgSqlURLProtocolTable
	implements ICFBamURLProtocolTable
{
	...
	public CFBamPgSqlURLProtocolTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFIntURLProtocolBuff Buff )
	{
		...
		try {
			...
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_urlproto( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
	...
	public String S_sqlSelectURLProtocolDistinctClassCode = null;
	...
	public String S_sqlSelectURLProtocolBuff = null;
	...
	public CFIntURLProtocolBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int URLProtocolId )
	{
		final String S_ProcName = "CFBamPgSqlURLProtocolTable.readDerivedByIdIdx() ";
		CFIntURLProtocolBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntURLProtocolBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFBamPgSqlURLProtocolTable.readDerivedByUNameIdx() ";
		CFIntURLProtocolBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFIntURLProtocolPKey PKey )
	{
		...
		try {
			...
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_urlproto( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		CFIntURLProtocolPKey PKey )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			int URLProtocolId = PKey.getRequiredURLProtocolId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_urlproto( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
	...
	public CFIntURLProtocolBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_urlproto_all( ?, ?, ?, ?, ? )";
		...
		int URLProtocolId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_urlproto_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		String Name )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_urlproto_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		boolean IsSecure )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_urlproto_by_issecureidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
		...
		CFIntURLProtocolBuff Buff )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_urlproto( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
		...
		CFIntURLProtocolBuff Buff )
	{
		...
		try {
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_urlproto( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		int argURLProtocolId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_urlproto_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		String argName )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_urlproto_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
		...
		boolean argIsSecure )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_urlproto_by_issecureidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
