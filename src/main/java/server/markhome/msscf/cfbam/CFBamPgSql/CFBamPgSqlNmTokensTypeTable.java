// Description: Java 11 PostgreSQL Jdbc DbIO implementation for NmTokensType.
...
/*
 *	CFBamPgSqlNmTokensTypeTable PostgreSQL Jdbc DbIO implementation
 *	for NmTokensType.
 */
public class CFBamPgSqlNmTokensTypeTable
	implements ICFBamNmTokensTypeTable
{
	...
	public CFBamPgSqlNmTokensTypeTable( CFBamPgSqlSchema argSchema ) {
		schema = argSchema;
	}

	public void createNmTokensType( CFSecAuthorization Authorization,
		CFBamNmTokensTypeBuff Buff )
	{
		...
		try {
			...
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_create_nmtknstyp( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
			...
			if( resultSet.next() ) {
				CFBamNmTokensTypeBuff createdBuff = unpackNmTokensTypeResultSetToBuff( resultSet );
				if( resultSet.next() ) {
	...
	public String S_sqlSelectNmTokensTypeDistinctClassCode = null;

	public String getSqlSelectNmTokensTypeDistinctClassCode() {
		if( S_sqlSelectNmTokensTypeDistinctClassCode == null ) {
			S_sqlSelectNmTokensTypeDistinctClassCode =
					"SELECT "
					...
					+		"AND a82b.Id = a809.Id "
						+	"INNER JOIN " + schema.getLowerDbSchemaName() + ".nmtknstyp a82c ON "
					+		"a82c.TenantId = a809.TenantId "
					+		"AND a82c.Id = a809.Id ";
		}
		return( S_sqlSelectNmTokensTypeDistinctClassCode );
	}

	public String S_sqlSelectNmTokensTypeBuff = null;

	public String getSqlSelectNmTokensTypeBuff() {
		if( S_sqlSelectNmTokensTypeBuff == null ) {
			S_sqlSelectNmTokensTypeBuff =
					"SELECT "
					+		"a809.ClassCode, "
					+		"a809.TenantId, "
					+		"a809.Id, "
		...
		return( S_sqlSelectNmTokensTypeBuff );
	}

	protected CFBamNmTokensTypeBuff unpackNmTokensTypeResultSetToBuff( ResultSet resultSet )
	throws SQLException
	{
		final String S_ProcName = "unpackNmTokensTypeResultSetToBuff";
		int idxcol = 1;
		String classCode = resultSet.getString( idxcol );
		idxcol++;
		CFBamNmTokensTypeBuff buff;
		if( classCode.equals( "a82c" ) ) {
	...
	public CFBamNmTokensTypeBuff readDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamNmTokensTypeBuff lockDerived( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
	...
	public CFBamNmTokensTypeBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "readAllDerived";
		CFBamNmTokensTypeBuff[] buffArray;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
				"Transaction not open" );
	...
	public CFBamNmTokensTypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		final String S_ProcName = "CFBamPgSqlNmTokensTypeTable.readDerivedByIdIdx() ";
		CFBamNmTokensTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFBamNmTokensTypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		final String S_ProcName = "CFBamPgSqlNmTokensTypeTable.readDerivedByUNameIdx() ";
		CFBamNmTokensTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFBamNmTokensTypeBuff[] readDerivedByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		CFBamNmTokensTypeBuff[] buffList = readBuffByValTentIdx( Authorization,
				TenantId );
		return( buffList );

	}

	public CFBamNmTokensTypeBuff[] readDerivedByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		CFBamNmTokensTypeBuff[] buffList = readBuffByScopeIdx( Authorization,
				TenantId,
				ScopeId );
		return( buffList );
	...
	public CFBamNmTokensTypeBuff[] readDerivedByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long DefSchemaId )
	{
		...
		CFBamNmTokensTypeBuff[] buffList = readBuffByDefSchemaIdx( Authorization,
				DefSchemaTenantId,
				DefSchemaId );
		return( buffList );
	...
	public CFBamNmTokensTypeBuff[] readDerivedByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		CFBamNmTokensTypeBuff[] buffList = readBuffByPrevIdx( Authorization,
				PrevTenantId,
				PrevId );
		return( buffList );
	...
	public CFBamNmTokensTypeBuff[] readDerivedByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		CFBamNmTokensTypeBuff[] buffList = readBuffByNextIdx( Authorization,
				NextTenantId,
				NextId );
		return( buffList );
	...
	public CFBamNmTokensTypeBuff[] readDerivedByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		CFBamNmTokensTypeBuff[] buffList = readBuffByContPrevIdx( Authorization,
				TenantId,
				ScopeId,
				PrevId );
		return( buffList );
	...
	public CFBamNmTokensTypeBuff[] readDerivedByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		CFBamNmTokensTypeBuff[] buffList = readBuffByContNextIdx( Authorization,
				TenantId,
				ScopeId,
				NextId );
		return( buffList );
	...
	public CFBamNmTokensTypeBuff[] readDerivedBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		CFBamNmTokensTypeBuff[] buffList = readBuffBySchemaIdx( Authorization,
				TenantId,
				SchemaDefId );
		return( buffList );
	...
	public CFBamNmTokensTypeBuff readBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		...
		try {
			...
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
			...
			if( resultSet.next() ) {
				CFBamNmTokensTypeBuff buff = unpackNmTokensTypeResultSetToBuff( resultSet );
				if( resultSet.next() ) {
					throw new CFLibRuntimeException( getClass(),
						S_ProcName,
						"Did not expect multi-record response" );
	...
	public CFBamNmTokensTypeBuff lockBuff( CFSecAuthorization Authorization,
		CFBamValuePKey PKey )
	{
		...
		try {
			...
			long TenantId = PKey.getRequiredTenantId();
			long Id = PKey.getRequiredId();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_lock_nmtknstyp( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_all( ?, ?, ?, ?, ? )";
			...
			List<CFBamNmTokensTypeBuff> buffList = new LinkedList<CFBamNmTokensTypeBuff>();
			while( resultSet.next() ) {
				CFBamNmTokensTypeBuff buff = unpackNmTokensTypeResultSetToBuff( resultSet );
				buffList.add( buff );
			}
			int idx = 0;
			CFBamNmTokensTypeBuff[] retBuff = new CFBamNmTokensTypeBuff[ buffList.size() ];
			Iterator<CFBamNmTokensTypeBuff> iter = buffList.iterator();
			while( iter.hasNext() ) {
	...
	public CFBamNmTokensTypeBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		long TenantId,
		long Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff readBuffByUNameIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		String Name )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff[] readBuffByValTentIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_valtentidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff[] readBuffByScopeIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_scopeidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff[] readBuffByDefSchemaIdx( CFSecAuthorization Authorization,
		Long DefSchemaTenantId,
		Long DefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff[] readBuffByPrevIdx( CFSecAuthorization Authorization,
		Long PrevTenantId,
		Long PrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_previdx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff[] readBuffByNextIdx( CFSecAuthorization Authorization,
		Long NextTenantId,
		Long NextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_nextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff[] readBuffByContPrevIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long PrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_contprevidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff[] readBuffByContNextIdx( CFSecAuthorization Authorization,
		long TenantId,
		long ScopeId,
		Long NextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_contnextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public CFBamNmTokensTypeBuff[] readBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_read_nmtknstyp_by_schemaidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " )";
	...
	public void updateNmTokensType( CFSecAuthorization Authorization,
		CFBamNmTokensTypeBuff Buff )
	{
		...
		try {
			...
			Connection cnx = schema.getCnx();
			String sql =
				"select * from " + schema.getLowerDbSchemaName() + ".sp_update_nmtknstyp( ?, ?, ?, ?, ?, ?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
						+	"?" + ", "
			...
			if( resultSet.next() ) {
				CFBamNmTokensTypeBuff updatedBuff = unpackNmTokensTypeResultSetToBuff( resultSet );
				if( resultSet.next() ) {
					throw new CFLibRuntimeException( getClass(),
						S_ProcName,
						"Did not expect multi-record response" );
	...
	public void deleteNmTokensType( CFSecAuthorization Authorization,
		CFBamNmTokensTypeBuff Buff )
	{
		...
		try {
			...
			String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	public void deleteNmTokensTypeByIdIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_ididx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeByIdIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredId() );
	}

	public void deleteNmTokensTypeByUNameIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		String argName )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_unameidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeByUNameIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredScopeId(),
			argKey.getRequiredName() );
	}

	public void deleteNmTokensTypeByValTentIdx( CFSecAuthorization Authorization,
		long argTenantId )
	{
		final String S_ProcName = "deleteNmTokensTypeByValTentIdx";
		ResultSet resultSet = null;
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_valtentidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeByValTentIdx( Authorization,
			argKey.getRequiredTenantId() );
	}

	public void deleteNmTokensTypeByScopeIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_scopeidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeByScopeIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredScopeId() );
	}

	public void deleteNmTokensTypeByDefSchemaIdx( CFSecAuthorization Authorization,
		...
		Long argDefSchemaId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeByDefSchemaIdx( Authorization,
			argKey.getOptionalDefSchemaTenantId(),
			argKey.getOptionalDefSchemaId() );
	}

	public void deleteNmTokensTypeByPrevIdx( CFSecAuthorization Authorization,
		...
		Long argPrevId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_previdx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeByPrevIdx( Authorization,
			argKey.getOptionalPrevTenantId(),
			argKey.getOptionalPrevId() );
	}

	public void deleteNmTokensTypeByNextIdx( CFSecAuthorization Authorization,
		...
		Long argNextId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_nextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeByNextIdx( Authorization,
			argKey.getOptionalNextTenantId(),
			argKey.getOptionalNextId() );
	}

	public void deleteNmTokensTypeByContPrevIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argPrevId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_contprevidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeByContPrevIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredScopeId(),
			argKey.getOptionalPrevId() );
	}

	public void deleteNmTokensTypeByContNextIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argScopeId,
		Long argNextId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_contnextidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeByContNextIdx( Authorization,
			argKey.getRequiredTenantId(),
			argKey.getRequiredScopeId(),
			argKey.getOptionalNextId() );
	}

	public void deleteNmTokensTypeBySchemaIdx( CFSecAuthorization Authorization,
		long argTenantId,
		long argSchemaDefId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "SELECT " + schema.getLowerDbSchemaName() + ".sp_delete_nmtknstyp_by_schemaidx( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + " ) as DeletedFlag";
	...
	{
		deleteNmTokensTypeBySchemaIdx( Authorization,
			argKey.getRequiredTenantId(),
	 ...
	 */
	public CFBamNmTokensTypeBuff moveBuffUp( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int argRevision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_moveup_nmtknstyp( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", ? )";
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public CFBamNmTokensTypeBuff moveBuffDown( CFSecAuthorization Authorization,
		long TenantId,
		long Id,
		int argRevision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "SELECT * FROM " + schema.getLowerDbSchemaName() + ".sp_movedown_nmtknstyp( ?, ?, ?, ?, ?" + ", "
					+		"?" + ", "
					+		"?" + ", ? )";
	...
	public void releasePreparedStatements() {
		...
		S_sqlSelectNmTokensTypeDistinctClassCode = null;
		S_sqlSelectNmTokensTypeBuff = null;
